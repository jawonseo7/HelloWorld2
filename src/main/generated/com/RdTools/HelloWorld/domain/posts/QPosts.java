package com.RdTools.HelloWorld.domain.posts;
...
public class QPosts extends EntityPathBase<Posts> {
    ...
    private static final long serialVersionUID = 1174484778L;

    public static final QPosts posts = new QPosts("posts");

    public final com.RdTools.HelloWorld.domain.QBaseTimeEntity _super = new com.RdTools.HelloWorld.domain.QBaseTimeEntity(this);
